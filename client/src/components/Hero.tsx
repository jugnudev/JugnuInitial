      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col gap-4 justify-center items-center max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full">
              {hasTicketsAvailable ? (
                <a
                  ...
                  className="flex-1 inline-flex items-center justify-center px-8 py-4 bg-primary text-black/90 font-medium tracking-wide rounded-2xl hover:bg-primary-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-bg transition-all duration-200 shadow-lg hover:shadow-xl btn-glow"
                ...
                <Link
                  href="/account/signup"
                  className="flex-1 inline-flex items-center justify-center gap-2 px-8 py-4 text-black/90 font-medium tracking-wide rounded-2xl hover:bg-primary-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-bg transition-all duration-200 shadow-lg hover:shadow-xl btn-glow bg-[#c05a0e]"
            ...
            {/* Business CTA - Tertiary but prominent */}
            {!isAuthenticated && (
              <div className="w-full text-center">
                <p className="text-white/80 text-sm mb-2">Are you an organizer, venue, or artist?</p>
                <Link
                  href="/business/signup"
                  className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white/5 text-white border border-white/20 font-medium tracking-wide rounded-xl hover:bg-white/10 hover:border-white/30 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-bg transition-all duration-200"
