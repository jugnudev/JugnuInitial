...
export function TicketsEventEditPage() {
  ...
  // Sync fee amount input when form value changes
  useEffect(() => {
    const amountCents = form.getValues('serviceFeeAmountCents');
    setFeeAmountInputValue((amountCents / 100).toFixed(2));
  }, [form.watch('serviceFeeAmountCents')]);
