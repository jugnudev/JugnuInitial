...
import { Users, Eye, TrendingUp, Activity, Monitor, Smartphone, Tablet, Globe, RefreshCcw, Clock, Download, BarChart3 } from 'lucide-react';
            ...
            <CardHeader className="space-y-1 pb-4">
              <div className="flex items-center justify-center mb-4">
                <div className="p-3 rounded-full bg-copper-500/20 ring-4 ring-copper-500/10">
                  <BarChart3 className="w-8 h-8 text-copper-500" />
                </div>
              </div>
              ...
              <form onSubmit={handleLogin} className="space-y-6">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full h-12 px-4 bg-black/40 border border-gray-700 rounded-lg text-white placeholder:text-gray-500 focus:border-copper-500 focus:ring-2 focus:ring-copper-500/20 outline-none transition-all"
                    required
                    autoComplete="off"
                  />
                </div>
                <Button type="submit" className="w-full h-12 bg-gradient-to-r from-copper-500 to-orange-600 hover:from-copper-600 hover:to-orange-700 !text-white font-bold text-base shadow-xl shadow-copper-500/30">
                  Access Analytics
                </Button>
              </form>
            </CardContent>
