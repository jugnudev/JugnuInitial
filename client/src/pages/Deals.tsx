...
const slotConfigs: Array<{ 
  ...
  { slot: 1, tileKind: 'wide', gridClass: 'col-span-12', aspectRatio: 'aspect-[4/1] md:aspect-[5/1]' },
  ...
  { slot: 5, tileKind: 'tall', gridClass: 'col-span-12 md:col-span-4', aspectRatio: 'aspect-[3/4]' },
  { slot: 6, tileKind: 'half', gridClass: 'col-span-12 md:col-span-4', aspectRatio: 'aspect-[3/2]' },
        ...
        >
          ...
          <div className="text-center mb-16">
            <motion.h1 
              ...
              className="font-fraunces text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4"
            >
              Exclusive Deals
            </motion.h1>
            <motion.p 
              ...
              return (
                ...
                >
                  {deal ? (
                    ...
                    <div className={`relative ${config.aspectRatio} rounded-2xl overflow-hidden bg-gradient-to-br from-white/5 to-white/10 border border-white/10 backdrop-blur-sm group hover:border-copper-500/30 transition-all duration-300 hover:shadow-2xl hover:shadow-copper-500/10`}>
