...
const slotConfigs: Array<{ 
  ...
  { slot: 1, tileKind: 'wide', gridClass: 'col-span-12', aspectRatio: 'aspect-[2/1] sm:aspect-[3/1] md:aspect-[4/1]' },
  { slot: 2, tileKind: 'half', gridClass: 'col-span-6 md:col-span-6', aspectRatio: 'aspect-square sm:aspect-[4/3] md:aspect-[3/2]' },
  { slot: 3, tileKind: 'half', gridClass: 'col-span-6 md:col-span-6', aspectRatio: 'aspect-square sm:aspect-[4/3] md:aspect-[3/2]' },
  { slot: 4, tileKind: 'square', gridClass: 'col-span-12 sm:col-span-6 md:col-span-4', aspectRatio: 'aspect-[4/3] sm:aspect-square' },
  ...
  { slot: 7, tileKind: 'wide', gridClass: 'col-span-12', aspectRatio: 'aspect-[2/1] sm:aspect-[3/1] md:aspect-[4/1]' },
];
